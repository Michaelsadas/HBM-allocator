...
#define BRANCH 4 //mini heap in one branch
#define BRANCH_BIAS 2 //log2(BRANCH)
...
#define DATA_BIAS 19 //the log2(size of one space)
...
static ap_uint<2 * HEAP_BIAS> used_free[16]; //one for free and one for allocate
