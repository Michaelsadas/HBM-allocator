...
#define TRUNK 32 //number of branches
#define TRUNK_BIAS 5 //log2(TRUNK)
#define L 8 //number of branches in one HBM stack assuming there are 16 HBM ports
#define B 4  //number of banks depending on HBM
#define HEAP_BIAS 3 //number of log2(spaces in one mini heap) + 1
#define DATA_BIAS 12 //the log2(size of one space)
...
static ap_uint<2 * HEAP_BIAS> used_free[2048]; //one for free and one for allocate
