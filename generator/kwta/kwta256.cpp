...
#define BRANCH 8 //mini heap in one branch
#define BRANCH_BIAS 3 //log2(BRANCH)
...
#define DATA_BIAS 17 //the log2(size of one space)
...
static ap_uint<2 * HEAP_BIAS> used_free[64]; //one for free and one for allocate
