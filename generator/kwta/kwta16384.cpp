...
#define BRANCH 64 //mini heap in one branch
#define BRANCH_BIAS 6 //log2(BRANCH)
...
#define DATA_BIAS 11 //the log2(size of one space)
...
static ap_uint<2 * HEAP_BIAS> used_free[4096]; //one for free and one for allocate
